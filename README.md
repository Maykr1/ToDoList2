...
## Description
This is my second iteration of a ToDoList. I would like to note that I did not choose to use docker-compose due to the fact that it's performance is worse than just running the containers separately.
